 ...
 * @since 1.0
 */
class VSP_Log_Handler_Email extends VSP_Log_Handler {
	/**
	...
	public function set_threshold( $level ) {
		$this->threshold = VSP_Log_Levels::get_level_severity( $level );
	}
	...
	protected function add_log( $timestamp, $level, $message, $context ) {
		...
		$log_severity = VSP_Log_Levels::get_level_severity( $level );
	...
	protected function get_subject() {
		...
		$max_level = strtoupper( VSP_Log_Levels::get_severity_level( $this->max_severity ) );
